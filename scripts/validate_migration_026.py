#!/usr/bin/env python3
"""Validate migration 026 (phase 5) with pglast — parse every statement,
splitting on semons at top level only (skip ; inside $$ dollar-quoted bodies).
Mirrors the phase-4 validation approach."""
import re
import sys
...
PATH = "supabase/migrations/026_phase5_notifications_center.sql"
