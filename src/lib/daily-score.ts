// ============================================================
// daily-score.ts — المعادلة الموحدة لدرجة اليوم
//
// رقم واحد لـ«تقدم اليوم» تستهلكه مسارات dashboard و
// productivity-score، فيتساوى رقم الكارت الكبير والهيدر والمراجعات
// الأسبوعية/الشهرية. شرح الأوزان وسبب التوحيد في التعليق أدناه.
//
// المسؤوليات:
//   1) computeDailyScore: أجزاء مرجّحة (مهام .35 / عادات .25 /
//      صباح .20 / تركيز .20) تُعاد تسويتها على المتوفر فعلاً اليوم
//      + 10% للسلسلة، وتعيد الدرجة مع تفصيل الأجزاء.
//   2) habitDueOn: استحقاق العادة في تاريخٍ ما (daily/weekdays/
//      weekends) بمثبت 12:00 ظهراً ضد انزياح المنطقة الزمنية.
//   3) ثابتا الأهداف: 60 دقيقة تركيز و30 يوماً سلسلة كسقفَي نسبة.
//
// حدود: دوال حسابية نقية — بلا I/O ولا حالة؛ كل المدخلات (اليوم/
// السلسلة/العدادات) تُحسب في المستدعي قبل الاستدعاء.
// ============================================================
