...
// ============================================================
// data/journals.ts — مستودع «اليوميات»
//
// كتابة اليوم وتقييمه: get ليوم بعينه، list (آخر 30)، وupsert
// ذري على (user_id, date) اعتماداً على القيد الفريد من الهجرة
// 005 — الكتابة المتزامنة ليوم واحد تذوب في كتابة واحدة.
// ============================================================
