...
// ============================================================
// avatars.tsx — ثيمات الأفاتار (24 ثيماً)
//
// يعرّف AVATARS: لكل ثيم معرّف واسم عربي وتدرّج لوني وأيقونة SVG
// مضمّنة. تعرضها الإعدادات للاختيار، ويستهلكها الشريط الجانبي وشاشة
// المجتمع لعرض صورة المستخدم بلا أي أصول صور خارجية.
//
// المسؤوليات:
//   1) توفير 24 ثيماً ثابتاً بمعرّفات مثل ocean-3، موزعة على مجموعات
//      (طبيعة/محيط/غروب/جبال/سماء/شمس-قمر/ذهبي/تجريدي/أرض/صحراء/ورد).
//      كل عنصر يحمل style (تدرّج الخلفية) وsvg (الأيقونة).
//   2) توحيد عرض الأفاتار عبر كل الشاشات بالبحث بالمعرّف:
//      AVATARS.find(a => a.id === key) كما في community.tsx.
//
// حدّ جوهري: قيمة avatar في قاعدة البيانات مفتاح ثيم وليست رابط
// صورة — تمريرها كـ <img src> يسبب 404؛ اعرضها تدرّجاً + SVG فقط.
// ============================================================
