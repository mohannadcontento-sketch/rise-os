...
// ============================================================
// sounds.ts — المؤثرات الصوتية المولّدة برمجياً
//
// 14 مؤثراً تُولَّد لحظياً بـ Web Audio API على سلّم خماسي (لا ملفات
// أصول ولا تحميل شبكي). تستهلكها وحدات الواجهة عبر playSound عند
// إنجاز المهام والعادات وجلسات التركيز والإنجازات والأخطاء والتنقل.
//
// المسؤوليات:
//   1) بوابة إيماءة المستخدم: لا يُنشأ AudioContext قبل أول تفاعل
//      (سياسات autoplay) ويُستأنف تلقائياً بعدها عند اللزوم.
//   2) احترام تفضيلات rise-settings (تفعيل/مستوى الصوت) المقروءة
//      عبر غلاف user-storage المعزول لكل مستخدم.
//   3) playSound/areSoundsEnabled/getSoundVolume: نجاح صامت دائماً
//      — الصوت تحسين ولا يكسر الوظيفة أبداً.
//
// حدود: كل نغمة oscillators ومغلّفات ADSR — لا تسجيل ولا مزامنة
// خادم ولا مسارات صوتية هنا.
// ============================================================
