...
// ============================================================
// icons.tsx — مكتبة أيقونات «أوج» (Neo Duotone)
//
// نظام الأيقونات المشترك للواجهة كلها: محارف SVG مرسومة يدويًا
// على شبكة 24×24 (خطوط عريضة مستديرة) تسكن «آبارًا» مصبوغة
// بدرجة لون (RiseHue عبر .icon-well/.iw-* في globals.css).
// نهاريًا بئر باستيل + محرف داكن، وليليًا بئر متوهج + توهج
// لوني — فيتميز كل مقطع باللون كما بالشكل. يُستورد من الشريط
// الجانبي والوحدات وصفحة الهبوط والإشعارات.
//
// البنية الداخلية:
//   1) محارف الوحدات (RiseGlyph) + RiseIcon (محرف داخل بئر
//      ملوّن) و RiseGlyphIcon (محرف مجرد لسطح ملون أصلًا)
//   2) محارف العادات (HabitGlyphKey) + HabitIcon/HabitGlyph مع
//      HABIT_ICON_PRESETS لمنتقي العادات و EMOJI_TO_GLYPH
//      لتطبيق العادات القديمة المخزنة كإيموجي
//   3) MODULE_ICONS — خريطة «الوحدة ← محرف + درجة لون»
//      (مصدر الحقيقة الوحيد لهوية الوحدات)
//
// مبادئ التصميم/تقنية: كل الرسوم aria-hidden (التسمية النصية
// مسؤولية النداء الأب)؛ أحجام sm/md/lg ثابتة؛ HabitIcon يصبغ
// البئر بلون العادة نفسه ويبرز الإكمال بحلقة توهج، وما لا
// يقابل برمز يبقى إيموجي داخل نفس البلاطة.
// ============================================================
