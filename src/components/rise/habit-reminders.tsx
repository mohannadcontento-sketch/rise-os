...
// ============================================================
// habit-reminders.tsx — تذكيرات العادات (وحدة «العادات»)
//
// قطعتان تُستوردان داخل habits.tsx فقط: شريط «التذكيرات
// القادمة» أعلى الوحدة، وزر جرس لكل بطاقة عادة لضبط وقت
// التذكير أو إلغائه. الكتابة تتم عبر onToggleReminder الخاص
// بالوحدة الأم — هذا الملف عرض خالص بلا جلب بيانات.
//
// البنية الداخلية:
//   1) HabitReminders — ساعة حية (تحديث كل دقيقة) + فلترة
//      العادات ذات تذكير خلال الساعتين القادمتين وعرض
//      «خلال X دقيقة»
//   2) ReminderBell — مفتاح BellToggle + نافذة إدخال وقت
//      منبثقة (إدخال time + إلغاء/حفظ)
//
// مبادئ UX/تقنية: إطلاق التذكير نفسه انتقل إلى ReminderEngine
// المركّب في هيكل التطبيق (هنا عرض فقط — لا toasts مكررة)؛
// وقت التذكير يُعرض dir="ltr" بخط num؛ الإلغاء يعيد الحقل
// إلى القيمة المحفوظة للعادة لا القيمة المكتوبة.
// ============================================================
