...
# ⛰️ أوج | awj.life — نظام حياتك الشخصي

### صُنع بأيدٍ عربية — سابقًا RiseOS
...
**أوج** (Awj) ليس مجرد تطبيق مهام — هو **نظام تشغيل كامل لحياتك**. يدمج بين:
...
```
وضع نهاري "Dawn Paper":  ورق دافئ #F4F2EA + أخضر غابي #1B342B + ليموني #D6FF3D
وضع ليلي "Obsidian Aurora": أوبسيديان #070B14 + ليموني متوهج + أورورا بنفسجية
حالات موحدة:             success / warning / error / info (رموز دلالية AA)
Radius:                   1rem أساس (sm/md/lg/xl/2xl مشتقة)
```
التوثيق الكامل: `docs/phase-2/DESIGN.md`
...
│
├── components/
│   ├── rise/                   # 35 مكون أوج (Neo)
│   │   ├── dashboard.tsx       # لوحة التحكم (1865 سطر)
│   │   ├── tasks.tsx           # المهام مع Kanban + DnD
│   │   ├── onboarding.tsx      # معالج الترحيب (4 خطوات)
│   │   ├── login-page.tsx      # صفحة تسجيل الدخول
│   │   ├── sidebar.tsx         # الشريط الجانبي (تسميات موحدة من lib/module-labels)
│   │   ├── settings.tsx        # الإعدادات + لوحة الأدمن
│   │   ├── keyboard-shortcuts.tsx
│   │   └── ... (20 وحدة)
│   └── ui/                     # 23 مكون shadcn/ui
│
├── lib/
...
│
├── hooks/
│   ├── use-today.ts           # تاريخ اليوم (hydration-safe)
│   └── ... (5 hooks)
│
└── public/
    ├── manifest.json          # PWA manifest
    ├── sw.js                  # Service Worker
    ├── icon.svg / logo.svg    # علامة أوج (الشمس في أوجها)
...
- [x] معالج ترحيب 4 خطوات للمستخدمين الجدد
...
1. **الأداء**: تقليل حجم الحزمة الأولية أكثر (lazy load recharts)
...
Made with ⚡ by فريق أوج — [awj.life](https://awj.life)
