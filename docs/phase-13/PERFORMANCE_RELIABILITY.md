...
- ✅ **Upstash مربوط (الخطة المجانية) 2026-09-14** — `UPSTASH_REDIS_REST_URL`/`TOKEN`. ملاحظة تفعيل: متغيرات البيئة تلزمها إعادة نشر لتصبح فعالة؛ التحقق النهائي = 6 محاولات دخول فاشلة متتالية من نفس الجهاز بعد أول deploy جديد → المحاولة السادسة 429 (قبل الربط كانت الحدود لكل-نسخة بالذاكرة). لو لم تظهر: تأكد أنها مضافة لبيئة **Production** بالأسماء الحرفية ثم Redeploy.
