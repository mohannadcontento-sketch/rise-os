...
1. المكررات النوعية (Task/Project/Habit/Goal معرّفة 2-3 مرات) → مركز types موحد في المرحلة 02.
2. ‏`lib/data.ts` (barrel) مقابل `lib/data/` (مجلد) — إعادة تسمية في المرحلة 02.
